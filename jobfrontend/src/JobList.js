...
class JobList extends Component {
    ...
    createJob = async (job, index) => {
      try {
          const newJobResponse = await fetch('http://ec2-18-234-89-173.compute-1.amazonaws.com:8081/job/add', {
          method: 'post',
          headers: {
    ...
    editJob = async (job, jobId, index) => {
      try {
          const editJobResponse = await fetch('http://ec2-18-234-89-173.compute-1.amazonaws.com:8081/job/edit/'+ jobId, {
          method: 'put',
          headers: {
            'Accept': 'application/json, text/plain, */*',
            'Content-Type': 'application/json'
    ...
    deleteJob = async (job, jobId, index) => {
          ...
          const deleteJobResponse = await fetch('http://ec2-18-234-89-173.compute-1.amazonaws.com:8081/job/delete/'+ jobId, {
          method: 'delete',
          headers: {
            'Accept': 'application/json, text/plain, */*',
            'Content-Type': 'application/json'
